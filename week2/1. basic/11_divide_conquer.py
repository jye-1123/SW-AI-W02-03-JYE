...
def find_max_divide_conquer(arr, left, right):
    ...
    # TODO: 왼쪽 절반의 최댓값
    pass
    left_divide_max = find_max_divide_conquer(arr, left, mid)
    
    # TODO: 오른쪽 절반의 최댓값
    pass
    right_divide_max = find_max_divide_conquer(arr, mid+1, right)

    # TODO: 둘 중 큰 값 반환
    return left_divide_max if left_divide_max > right_divide_max else right_divide_max
